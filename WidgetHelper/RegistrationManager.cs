...
namespace WidgetHelper
{
        ...
        where TWidgetProvider : IWidgetProvider, new()
    {
        ...
        {
            public ClassLifetimeUnregister(uint registrationHandle)
            {
                COMRegistrationHandle = registrationHandle;
            }
        ...
        {
            var registration = RegisterClass(
                typeof(TWidgetProvider).GUID,
                new WidgetProviderFactory<TWidgetProvider>()
            );
