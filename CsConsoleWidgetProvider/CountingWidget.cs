...
namespace CsConsoleWidgetProvider
{
    internal class CountingWidget : WidgetImplBase
    {
        ...
        public CountingWidget(string widgetId, string startingState)
        ...
        private static string GetDefaultTemplate()
        {
            if (string.IsNullOrEmpty(WidgetTemplate))
            {
                ...
                WidgetTemplate = ReadPackageFileFromUri(
                    "ms-appx:///Templates/CountingWidgetTemplate.json"
                );
            }
        ...
        {
            var stateNode = new JsonObject { ["count"] = State };
